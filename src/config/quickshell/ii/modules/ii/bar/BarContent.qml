...
Item {
    ...
    Item {
        ...
        Item {
            ...
            anchors.leftMargin: root.isMaterial ? (Appearance.sizes.hyprlandGapsOut) : (Config.options.bar.cornerStyle === 1 ? 4 : 10)
        ...
        Item {
            ...
            anchors.rightMargin: root.isMaterial ? (Appearance.sizes.hyprlandGapsOut) : (Config.options.bar.cornerStyle === 1 ? 4 : 10)
            anchors.top: parent.top
            anchors.bottom: parent.bottom
